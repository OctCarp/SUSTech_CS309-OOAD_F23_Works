...
public class Client {
    public static void main(String[] args) {
        ...
        System.out.println("Please input operation number to add a command: 1- 9, " +
            "[1,3,5,7] is on command, [2,4,6,8] is off command, 9 is to show state. " +
            "10 is to execute command. 11 to undo previous command terminate by 0:");
            ...
            try {
                ...
                switch (op) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        showState(new AirConditioner[]{roomAirConditioner, livingAirConditioner}, new Light[]{roomLight, livingLight});
                        break;
                    case 10:
